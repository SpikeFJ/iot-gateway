...
//
//        String s = "3332393633383630353831353834383433323936333836303538313538343834";

        byte[] bytes = ByteBufUtil.decodeHexDump("33323936333836303538313538343834696f742e68616f6b7561692e636e");
        String s1 = new String(bytes, Charset.forName("ASCII"));
