  ...
  <div class="mr-12 md:w-48 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
    ...
    <span class="mt-1 text-gray-500 text-sm">
      <div class="grid grid-cols-4 whitespace-nowrap">
        ...
        <div class="w-14 h-1 col-span-2 text-gray-900 dark:text-white">设备编号</div>
        <div class="w-14 h-1 col-span-2 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{basic.deviceId}}</div>
        <div class="w-14 h-1 col-span-2 text-gray-900 dark:text-white">业务编号</div>
        <div class="w-14 h-1 col-span-2 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{basic.bId}}</div>
